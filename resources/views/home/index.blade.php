...
<section class="content content-custom no-print">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-info">
            <div class="inner">
                <h3><span class="total_sell"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-success">
            <div class="inner">
                <h3><span class="net"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
                <p>{{ __('lang_v1.net') }} @show_tooltip(__('lang_v1.net_home_tooltip'))</p>
            </div>
            <div class="icon">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><span class="invoice_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
    ...
    <!-- Total Sell Return Box -->
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3><span class="total_sell_return"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
                <p>{{ __('lang_v1.total_sell_return') }}</p>
            </div>
            <div class="icon">
...
<div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-success">
            <div class="inner">
                <h3><span class="total_purchase"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><span class="purchase_due"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
...
<i class="fas fa-exclamation"></i>
    ...
    <!-- Total Purchase Return Box -->
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3><span class="total_purchase_return"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
                <p>{{ __('lang_v1.total_purchase_return') }}</p>
            </div>
            <div class="icon">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3><span class="total_expense"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span></h3>
                <p>{{ __('lang_v1.expense') }}</p>
            </div>
            <div class="icon">
