	...
	<thead>
		<tr>
			<td>
				<div class="row">
					<div class="col-xs-3">
						<img style="max-height: 120px; width: auto;" src="{{URL::asset('/uploads/invoice_logos/logo_surat_jalan.png')}}" class="img">
					</div>
					<div class="col-xs-9">
						<p class="text-left color-555 font-30">
...
<div class="row invoice-info mt-0">
	<div class="text-center mt-0"><h1>Surat Jalan</h1></div>
	<div class="col-md-6 invoice-col width-50 color-555">
		Kepada Yth.
		<p>{{ $receipt_details->display_name }}</p>
		<!-- Logo -->
