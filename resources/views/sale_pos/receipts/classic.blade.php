...
<div class="row" style="color: #000000 !important;">
	@if(empty($receipt_details->letter_head))
		...
		@endif
		<!-- <img style="" src="{{URL::asset('/uploads/invoice_logos/logo_surat_jalan.png')}}" class="img img-responsive center-block"> -->
		...
		<div class="col-xs-12 text-left" style="">
			<div class="col-xs-2">
				<img style="max-height:100px;" src="{{URL::asset('/uploads/invoice_logos/logo_surat_jalan.png')}}" class="img img-responsive center-block">
			</div>
			<div class="col-xs-10">
				<h1 class="text-left">
					<!-- Shop & Location Name  -->
				...
				<h4>Truck & Heavy machinaey Sparepart Supplier</h5>
			</div>
	...
	<!-- <div class="row"> -->
		<div class="col-xs-8">
			<!-- <div class="row"> -->
				...
				<div class="col-xs-9">
					<label for="">: {{$receipt_details->customer_name}}</label>
				</div>
				<div class="col-xs-3">
					<label for="">No PO</label>
				</div>
				<div class="col-xs-9">
					<label for="">: {{$receipt_details->ref_no}}</label>
				</div>
				<div class="col-xs-3">
					<label for="">tanggal</label>
				</div>
				<div class="col-xs-9">
					<label for="">: {{$receipt_details->transaction_date}}</label>
				</div>
			<!-- </div> -->
		</div>
		<div class="col-xs-4">
			...
			<div class="col-xs-7">
				<label for="">: {{$receipt_details->invoice_no}}</label>
			</div>
		</div>
	<!-- </div> -->
...
<div class="row" style="color: #000000 !important;">
	<div class="col-xs-12">
		...
		@if(!empty($receipt_details->discounted_unit_price_label))
			...
			@endphp
		@endif
		<table border="1" class="table table-responsive" style="table-layout: fixed;">
			<thead>
				<tr>
					<th width="3%">No</th>
			...
			@endphp
				...
				<!-- {{json_encode($line)}} -->
				 @php
					$final_total_price = $final_total_price + $line['unit_price_inc_tax_uf'];
					$final_disount = $final_disount + $line['line_discount'];
				 @endphp
					<tr>
						<td width="3%">{{$no = $no+1}} </td>
						<td>{{$line['name']}} </td>
						<td> </td>
						<!-- <td style="word-wrap:break-word"> {{json_encode($receipt_details)}}</td> -->
						<td>{{$line['quantity']}} </td>
						<td>{{$line['units']}} </td>
						<td>{{$line['unit_price_uf']}} </td>
					...
					<tr>
						<td colspan="6"></td>
						<td>Grand Total</td>
						<td>{{$final_total_price-$final_disount}}</td>
					</tr>
...
<table border="0" class="table mt-0 mb-0">
	<tr>
	...
	@if(!empty($receipt_details->payments))
		@foreach($receipt_details->payments as $payment)
			<!-- <tr> -->
			<th>{{($payment['method'] == 'Tunai ()(-)')?'Kembali':$payment['method']}}</th>
...
<div class="col-xs-4">
	...
	BCA - IDR <br>
	242-1888-819 <br>
	A/N PT BERSAMA SUKSES <br>
	PARTINDO <br>
	Cabang PULO BRAYAN MEDAN</p>
</div>
<div class="col-xs-4">
	<p>ATAU<br>
	Permata - IDR<br>
	181-5162-125<br>
	A/N PT BERSAMA SUKSES PARTIND<br>
	Cabang ZAINUL ARIFIN MEDAN<br></p>
</div>
<br>
